...
- :strawberry: [ADmad/SocialAuth plugin](https://github.com/ADmad/cakephp-social-auth) - A CakePHP plugin which allows you authenticate using social providers like Facebook/Google/Twitter etc. using [SocialConnect/auth](https://github.com/SocialConnect/auth) social sign on library.
